...
export const metadata = {
  ...
  description: "A plain-English guide for parents new to youth cycle racing in Devon, Cornwall, Somerset & Bristol — what each discipline involves, what to bring, British Cycling membership, and how to find your child's first race.",
};
