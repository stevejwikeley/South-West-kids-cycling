  ...
  return (
    <header style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 24px 120px" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
        ...
        <Link href="/admin/clubs/new" style={{ display: "inline-block", background: "#111111", color: "#FAFAF8", border: "none", padding: "11px 20px", fontWeight: 700, fontSize: 13 }}>
          + Add club
        </Link>
      </div>

      <p style={{ maxWidth: 480, fontSize: 14, lineHeight: 1.6, color: "#4A4A46", marginTop: 22 }}>
        Clubs shown on the public directory and available to link from any event.
      </p>

      <div style={{ marginTop: 36 }}>
        <ClubList clubs={clubs} editBasePath="/admin/clubs" />
      </div>
    </header>
  );
}
