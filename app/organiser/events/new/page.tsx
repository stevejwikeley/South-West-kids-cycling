import EventOrSeriesForm from "@/components/events/EventOrSeriesForm";
import { getClubs } from "@/lib/data";

export default async function NewOrganiserEventPage() {
  ...
  return (
    <header style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 24px 120px" }}>
      ...
      <EventOrSeriesForm redirectTo="/organiser" clubs={clubs} />
    </header>
  );
}
