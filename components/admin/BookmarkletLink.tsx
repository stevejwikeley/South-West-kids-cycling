...
const BOOKMARKLET = `javascript:(function(){var m=document.querySelector('main')||document.body;var t=(document.title+'\\n\\n'+m.innerText).trim().slice(0,3000);window.open('https://www.southwestkidscycling.uk/admin/ingest?prefill='+encodeURIComponent(t),'_blank');})();`;
  ...
  return (
    <div style={{ marginTop: 40, maxWidth: 560, padding: "16px 18px", background: "#F3F2EE", border: "1px solid #E4E2DD" }}>
      ...
      <p style={{ fontSize: 13, lineHeight: 1.6, color: "#4A4A46", marginBottom: 10 }}>
        Some sites (British Cycling, etc.) block automated fetching, so pasting their URL above won&apos;t work. Drag this into your bookmarks bar — on any event page, click it to open this ingest form pre-filled with that page&apos;s text.
      </p>
      <a
        href={BOOKMARKLET}
