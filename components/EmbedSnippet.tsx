  ...
  return (
    <div style={{ marginTop: 40, maxWidth: 640, padding: "16px 18px", background: "#F3F2EE", border: "1px solid #E4E2DD" }}>
      ...
      <p style={{ fontSize: 13, lineHeight: 1.6, color: "#4A4A46", marginBottom: 12 }}>
        Give your members the full Devon, Cornwall, Somerset &amp; Bristol youth calendar without leaving your own site. Filter it by region or discipline and get a ready-to-paste embed code, with a live preview.
      </p>
      <Link
        href="/embed-builder"
        className="mono"
